...
int main(int argc, char **argv)
{
    ...
    }
    {
        ...
        ASSERT(sizeof(vec) == 24, "Fill in the correct value.");
        {
            ...
            vec.resize(24);
            ASSERT(vec.size() == 24, "Fill in the correct value.");
        ...
        }
        {
            ...
            vec.push_back('c');
            vec.push_back('d');
            ASSERT(vec.size() == 28, "Fill in the correct value.");
            ASSERT(vec.capacity() == 256, "Fill in the correct value.");
            ASSERT(vec[15] == 'z', "Fill in the correct value.");
            ASSERT(vec[24] == 'a', "Fill in the correct value.");
            ASSERT(vec[25] == 'b', "Fill in the correct value.");
            ASSERT(vec[26] == 'c', "Fill in the correct value.");
            ASSERT(vec[27] == 'd', "Fill in the correct value.");
        }
    }
